...
select distinct advisor.i_id,instructor.name,instructor.dept_name from advisor,student,takes,instructor
where student.id = takes.id and advisor.i_id=instructor.id
